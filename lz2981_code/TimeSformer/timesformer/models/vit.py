...
class TimeSformer(nn.Module):
    #Debug: add pretrained=True,
    def __init__(self, img_size=224, patch_size=16, num_classes=400, num_frames=8, attention_type='divided_space_time',  pretrained_model='', pretrained=True, **kwargs):
        super(TimeSformer, self).__init__()
        # self.pretrained=True
        #Debug: change to self.pretrained = pretrained 
        self.pretrained = pretrained  # ✅ 可以通过外部控制; set pretrained=False in Vit-Tiny in model = TimeSformer(..)
